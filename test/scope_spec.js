...
describe('Scope', function() {
    ...
    describe('digest', function() {
        ...
        it('does not remove one-time-watches until value is de ned', function() {
            scope.$watch('::aValue', function() { });
            scope.$digest();
    ...
    describe('$applyAsync', function() {
        ...
        it('cancels and  ushes $applyAsync if digested  rst', function(done) {
            scope.counter = 0;
            scope.$watch(
                function(scope) {
                    scope.counter++;
    ...
    describe('$watchGroup', function() {
        ...
        it('uses the same array of old and new values on  rst run', function() {
            var gotNewValues, gotOldValues;
            scope.aValue = 1;
            scope.anotherValue = 2;
            scope.$watchGroup([
        ...
        it('does not call the zero-watch listener when deregistered  rst', function() {
            var counter = 0;
    ...
    describe('$watchCollection', function() {
        ...
        it('uses the new value as the old value on  rst digest', function() {
            scope.aValue = {a: 1, b: 2};
            var oldValueGiven;
            scope.$watchCollection(
                function(scope) { return scope.aValue; },
